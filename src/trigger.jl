...
CameraTargetTrigger(x::Integer, y::Integer, width::Integer=defaultTriggerWidth, height::Integer=defaultTriggerHeight; lerpStrength::Number=0.0, positionMode::String="NoEffect", xOnly::Bool=false, yOnly::Bool=false, nodes::Array{Tuple{T, T}, 1}=Tuple{Integer, Integer}[]) where {T <: Integer} = Trigger("cameraTargetTrigger", x=x, y=y, width=width, height=height, positionMode=positionMode, xOnly=xOnly, yOnly=yOnly, nodes=nodes, lerpStrength=lerpStrength)
...
MiniTextBoxTrigger(x::Integer, y::Integer, width::Integer=defaultTriggerWidth, height::Integer=defaultTriggerHeight; dialog_id::String="", mode::String="OnPlayerEnter", only_once::Bool=true, death_count::Integer=-1) = Trigger("minitextboxTrigger", x=x, y=y, width=width, height=height, dialog_id=dialog_id, mode=mode, only_once=only_once, death_count=death_count)
MusicFadeTrigger(x::Integer, y::Integer, width::Integer=defaultTriggerWidth, height::Integer=defaultTriggerHeight; direction::String="leftToRight", fadeA::Number=0.0, fadeB::Number=1.0, parameter::String="") = Trigger("musicFadeTrigger", x=x, y=y, width=width, height=height, direction=direction, fadeA=fadeA, fadeB=fadeB, parameter=parameter)
